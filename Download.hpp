...
//		data.total_size = 0;
//
//		map<string, Stock>::iterator it_start = stock_map.begin();
//		map<string, Stock>::iterator it_end = stock_map.begin();
//		range_start = min(range_start, total_progress);
//		range_end = min(range_end, total_progress);
//		advance(it_start, range_start);
//		advance(it_end, range_end);
//
//		for (auto itr = it_start; itr != it_end; itr++) {
//			data.size = 0;
//			memset(data.memory, '\0', data.total_size);
//
//			string symbol = itr->first;
