        ...
        switch (choice) {
            ...
            case 1: {
                ...
                for (int i = 0; i < current_tickers.size(); i++) {
                    ...
                    if ((int)price_map[current_ticker].size() < 2 * N + 1) {
                        cout << current_ticker + " days less than 2N + 1! Actual: " + to_string(price_map[current_ticker].size()) << endl;
            ...
            case 3: {
                ...
                if (group_selection == 1) group_name = 0;
                    ...
                    cout << "Incorrect selection. Please enter a valid choice." << endl;
                    break;
                }
